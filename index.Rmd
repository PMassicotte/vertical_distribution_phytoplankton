...
-   Maybe use all UVP data and not not only the 3 defined classes.
    ...
    -   These 3 classes are very large, and likely not capturing phytoplankton cells?
...
-   Make a graph exploring chla/cp ratio (often used as a photoacclimation) with other variables (Ek, Fv/Fm).
    - No relationships found using the data in this study. Why?
