...
<!-- This is an attempt to visualize if there are differences in phytoplankton absorption at 440 nm between open and ice-covered stations. -->

<!-- ```{r} -->
<!-- tf <- tempfile(fileext = ".png") -->
<!-- res <- pdf_convert( -->
<!--   here("graphs/22_boxplot_phyto_absorption_isolume_owd.pdf"), -->
<!--   filenames = tf, -->
<!--   format = "png", -->
<!--   dpi = 200, -->
<!--   verbose = FALSE, -->
