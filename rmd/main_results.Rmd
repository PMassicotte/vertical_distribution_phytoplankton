...
After exploring the CTD data, I found out that there were some unwanted peaks in both the florescence and transmittance data. Therefore, I have used a median moving median window ($n = 25$) to smooth the data (both transmittance and fluorescence).
